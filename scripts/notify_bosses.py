...
def main():
    ...
    for boss in SCHEDULED_BOSSES:
        ...
        # avisa na primeira execucao dentro da janela (log evita repetir)
        if 0 < minutes_until <= notify_minutes + 0.5:
